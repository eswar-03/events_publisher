        ...
        <div class = "content"><!--body content holder-->
            <div class = "container">
                <div class = "col-md-12"><!--body content title holder with 12 grid columns-->
                    <h1>What we Orginazing Events</h1><!--body content title-->
                </div>
            </div>
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            ...
                            lasts well into the wee hours, our Local Events venue , 2024team is here to make sure all your birthday
